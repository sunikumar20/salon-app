...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { address: @salon.address, company_name: @salon.company_name, gstin: @salon.gstin, pan_number: @salon.pan_number } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { address: @salon.address, company_name: @salon.company_name, gstin: @salon.gstin, pan_number: @salon.pan_number } }
